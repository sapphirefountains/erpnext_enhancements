...
**Blocked by:** WI-023, final QBO sync completed + sync retirement initiated (webhook subscription removed — WI-045's early step), full site backup (OD-6 RESOLVED 2026-07-14: branch (a) bulk delete)   **Blocks:** WI-029
...
## Preconditions
- **OD-6 ratified: SATISFIED 2026-07-14** — the business chose branch (a), bulk delete after the final sync (decision recorded in decisions/OPEN-DECISIONS.md). The archival protections stand: QBO read-only, `QuickBooks Raw Payload` retained, pre-delete CSV export. (review correction C4)
