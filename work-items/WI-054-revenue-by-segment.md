# WI-054: Revenue-by-segment (Commercial/Residential) reporting (OD-4-gated)
**Phase:** 2   **Type:** CONFIG   **Size:** M
**Blocked by:** OD-4, WI-026, WI-027   **Blocks:** nothing
...
## Preconditions
- OD-4 resolved (where segment lives; which values); WI-026 groups populated; if the project attribute needs a new custom field, THAT field ships as a **FIXTURE Custom Field** from the projects workstream (rule 2) before this item.
