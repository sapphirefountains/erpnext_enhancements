# WI-037: Tax Category + Tax Rule automation (OD-2-gated)
**Phase:** 1   **Type:** CONFIG   **Size:** M
**Blocked by:** OD-2, WI-036   **Blocks:** WI-038
...
## Preconditions
- WI-036 templates exist; OD-2 category names ratified.

## Scope
- Create Tax Categories (proposed: 'Taxable', 'Exempt - Government', 'Out of State'; Build-stream category only if OD-2 branch (a)/(c) requires document-level differentiation).
