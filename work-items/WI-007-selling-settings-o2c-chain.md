...
**Blocked by:** nothing (OD-3 noted, non-blocking)   **Blocks:** WI-008, WI-023, WI-022
...
- OD-3 branch: if Events is ruled a separate stream from Rent, add a 'Events' `Project Type` row and value-stream handling — enumerate only; do not resolve.
