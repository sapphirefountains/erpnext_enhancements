...
| `party_naming_rules.py` | What a party-linked record should be called — Project, Opportunity, Address. **No Frappe, no I/O**; unit-tested in CI against verbatim production records | `check`, `audit`, `in_scope`, `party_matches`, `collision_groups`, `summarise` | none — advisory, no validate hook |
