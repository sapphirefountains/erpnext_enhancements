...
| `party_naming.py` | The reads behind it, plus the whitelisted entry point the three forms call | `read_rows`, `attach_address_parties`, `audit_doctype`, `check_record` (whitelisted) | `public/js/party_naming_advisor.js` on all three forms; `report/party_naming_audit/` |
