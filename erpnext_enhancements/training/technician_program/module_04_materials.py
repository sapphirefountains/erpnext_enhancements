			...
			"blocks": [
				{
					...
					"content": (
						...
						"base is on the <b>wet</b> face — the side the load is pushing from, which is "
						"where the steel goes. A slab spanning between supports is in tension along "
						"the bottom, and over a support it is in tension along the <b>top</b>. A "
						"cantilevered edge is in tension on top all the way out.</p>"
						"<p>That is why rebar is not distributed evenly through a section like a "
						"filler. It is placed where the tension is, and it does nothing at all "
						"somewhere the concrete is only being squeezed. <b>Where the bar sits is the "
			...
			"blocks": [
				...
				},
				{
					...
					"content": (
						...
						"the pair, which is the one that gets consumed.</p>"
