...
**Browser Back walks the screens and Forward restores them** (v1.535.1). Every screen a
...
**The route says where the author is** (v1.535.1): `/desk/training-canvas` is the home
...
previous tab (v1.535.1). Returning to the page reloads nothing, and anything typed into a card is
