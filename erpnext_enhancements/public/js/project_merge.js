        ...
        if (!frm.is_new()) {
            frm.add_custom_button(__('Merge Project'), function () {
                frappe.prompt([
                    ...
                    frappe.confirm(
                        __('Are you sure you want to merge this project into {0}? This action cannot be undone.', [values.target_project]),
                        function () {
                            frappe.call({
