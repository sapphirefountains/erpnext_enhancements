...
- `sync_activity_costs` upserts `Activity Cost` per (employee, Activity Type) with
  ...
  Since v1.538.0 `Activity Cost.costing_rate` sits at **permlevel 1** (a Property Setter
...
gate on the rates it prints; Projects Manager was dropped in v1.538.0 and keeps the project
