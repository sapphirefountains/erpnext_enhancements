...
Roles are the four that can read Job Interval at permlevel 0 other than ``Employee``: a
Script Report whose readers cannot read its ``ref_doctype`` errors for exactly its intended
audience (``tests/test_workforce_report_labor_cost.py`` pins the set).
"""
