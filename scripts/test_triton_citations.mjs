...
import {
	...
	renderTokens,
	tokenizeCitations,
} from "../erpnext_enhancements/public/js/triton/citations.js";
...
const MANIFEST = [
	...
	{ k: 2, type: "erpnext_doc", label: "TASK-2026-00184", url: "/app/task/TASK-2026-00184?view=form" },
...
console.log("Triton citation renderer — the §4.10 degradation table\n");
...
test("§4.G.7 corpus: a relative value that leaves our origin is refused", () => {
	...
	assert.equal(isSafeUrl("/app/task/TASK-2026-00184?view=form"), true);
...
console.log(`Triton citation renderer: ${checks} assertions passed`);
