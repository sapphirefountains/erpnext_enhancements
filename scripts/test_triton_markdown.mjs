...
import { appendInline, renderBlocks, renderMarkdown } from "../erpnext_enhancements/public/js/triton/markdown.js";
...
console.log("Triton markdown renderer\n");
...
console.log(`Triton markdown renderer: ${checks} assertions passed`);
