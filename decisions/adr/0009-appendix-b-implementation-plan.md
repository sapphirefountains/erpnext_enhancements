...
|---|---|---|---|---|
| `erpnext_enhancements/modules.txt` | modified | append a `Chat` line (the 29th module) | Low | `tests/test_doctype_modules.py` asserts the directory mapping **and** the `modules.txt` registration; omission fails CI on the first DocType, loudly and immediately |
